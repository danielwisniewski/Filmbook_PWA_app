...
export class MainSearchPageFacadeService {
  ...
  public get lastResultHandlerService() : LastResultsHandlerService {
    if ( !this._lastResultHandlerService ) {
      this._lastResultHandlerService = this.injector.get(LastResultsHandlerService)
    }
  ...
  return this.searchMovieApiService.searchResult;
  }
  ...
  getLoadingStatus() : Observable<boolean> {
    return this.searchMovieApiService.isLoading$
  }
